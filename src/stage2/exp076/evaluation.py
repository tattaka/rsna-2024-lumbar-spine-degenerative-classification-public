...
from train import EXP_ID, RSNA2024Stage2LightningModel
...
def crop_axial(volume, img_size, in_chans, keypoint, instance_number, d, transform):
...
def feature_extract_st1_stage2(models, volume, mask):
    ...
    level_mask = mask.sum(1).bool()  # (level)
